...
for (n in c(100,200,600)) {
  for (p in c(50,100,300)) {
    ...
    save.image(paste0("~/pdl/review_p2/biometrics/simu/Mixd2/GFMMixEx1n",n/2,"p",p,".RData"))
  }
}
...
for (ni in c(100,200,600)) {
  for (pj in c(50,100,300)) {
    for (Exk in 1:2) {
      load(paste0("~/pdl/review_p2/biometrics/simu/Mixd2/Mix","Ex",Exk,"n",ni/2,"p",pj,".RData"))
      load(paste0("~/pdl/review_p2/biometrics/simu/Mixd2/GFMMix","Ex",Exk,"n",ni/2,"p",pj,".RData"))
